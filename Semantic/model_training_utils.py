...
def run_customized_training_loop(
    ...
    with strategy.scope():
        ...
        def train_step(inputs):
            ...
            source_ids, target_ids, labels = inputs[0]['source_ids'], inputs[0]['target_ids'], inputs[1]
            with tf.GradientTape() as tape:
                predictions = model([source_ids, target_ids], training=True)
        ...
        def eval_step(inputs):
            ...
            predictions = model([source_ids, target_ids], training=False)
