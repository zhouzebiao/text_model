...
class StringHelperTest(tf.test.TestCase):
    ...
    def test_split_string_to_tokens1(self):
        text = "<arg1> '' ' - a comprehensive course </arg1> <rel> covers </rel> <arg2> safe handling and transport of casualties </arg2>"
...
"""
export PYTHONPATH=/data/model;CUDA_VISIBLE_DEVICES='-1' python tokenizer_test.py
